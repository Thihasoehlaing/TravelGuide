            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                            ...
                            <div class="page-header">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Divisions</a></li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('postdivision') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="name">Division Name</label>
                                    <input type="text" class="form-control" name="name" id="name" placeholder="New Division Name">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="dlat" id="dlat" placeholder="Latitude">
                                    <input type="text" class="form-control" name="dlong" id="dlong" placeholder="Longtitude" style="margin-top:1%;">
                                </div>
